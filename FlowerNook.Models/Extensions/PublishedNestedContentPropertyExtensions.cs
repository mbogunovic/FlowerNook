...
namespace FlowerNook.Models.Extensions
{
	...
	public static class PublishedNestedContentPropertyExtensions
	{
		...
		public static TNestedContent GetNestedContentSinglePropertyValue<TNestedContent>(this IPublishedContent source, [CallerMemberName] string propertyName = null) where TNestedContent : class, INestedContent
